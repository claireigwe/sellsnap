...
NEXT_PUBLIC_FLW_PUBLIC_KEY   ← Flutterwave public key (safe for client, NEXT_PUBLIC_ prefix required by Next.js)
FLW_SECRET_HASH         ← Webhook verification hash (set in Flutterwave dashboard)
NEXT_PUBLIC_APP_URL     ← App base URL (e.g. http://localhost:3000 in dev, https://sellsnap.app in prod)
SENDGRID_API_KEY
```
